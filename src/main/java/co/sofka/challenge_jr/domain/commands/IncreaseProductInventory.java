...
public class IncreaseProductInventory extends Command {
  private final InventoryID inventoryID;
  private final ProductID productID;
  private final InInventory inInventory;

  public IncreaseProductInventory(InventoryID inventoryID, ProductID productID, InInventory inInventory) {
